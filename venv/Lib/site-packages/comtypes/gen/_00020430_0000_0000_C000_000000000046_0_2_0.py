...
IFontDisp = Font
__all__ = [ 'IFontEventsDisp', 'FontEvents', 'OLE_YSIZE_HIMETRIC',
           'OLE_XSIZE_PIXELS', 'StdFont', 'FONTBOLD', 'Font',
           'IPicture', 'LoadPictureConstants', 'FONTNAME', 'Gray',
           'Color', 'IFont', 'Monochrome', 'OLE_ENABLEDEFAULTBOOL',
           'OLE_YPOS_HIMETRIC', 'IFontDisp', 'OLE_XSIZE_CONTAINER',
           'OLE_YPOS_CONTAINER', 'OLE_XPOS_PIXELS', 'Unchecked',
           'Checked', 'VgaColor', 'OLE_XPOS_CONTAINER',
           'OLE_CANCELBOOL', 'OLE_YPOS_PIXELS', 'OLE_COLOR',
           'FONTSTRIKETHROUGH', 'FONTUNDERSCORE',
           'OLE_YSIZE_CONTAINER', 'OLE_TRISTATE', 'StdPicture',
           'OLE_XPOS_HIMETRIC', 'OLE_OPTEXCLUSIVE',
           'OLE_XSIZE_HIMETRIC', 'Picture', 'FONTSIZE', 'Default',
           'FONTITALIC', 'OLE_YSIZE_PIXELS', 'IPictureDisp',
           'OLE_HANDLE']
